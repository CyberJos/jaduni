...
public interface RenderEngine {
     ...
     * default render engine by default during initialization. A user doesn't
    ...
    public enum Holder {
         ...
         */
        private final Map<String, RenderEngine> renderEngineMapping = new ConcurrentHashMap<>();
        ...
        private Holder() {
            ...
            // TODO: automatically initialize all custom render engines by following mechanism
            /*
             * Map<String, RenderEngine> customMapping = Loader.load(RenderEngine.class);
             * this.renderEngineMapping.putAll(customMapping);
             */
        }

        /**
         * Returns the render engine associated with the given name, or
         * {@code null} if not found.
         *
         * @param renderEngineName the name of the render engine
         * @return the render engine associated with the given name, or
         *         {@code null} if not found
         * @throws NullPointerException if the given name is {@code null}
         * @throws IllegalArgumentException if the given name is blank
         */
        RenderEngine get(final String renderEngineName) {
            Validate.notBlank(renderEngineName, "The given name must not be null.");
            return this.renderEngineMapping.get(renderEngineName);
        }

        /**
         * Sets the render engine into the mapping with the given name. The
         * passed render engine can be {@code null}.
         *
         ...
         * @throws IllegalArgumentException if the given name is blank
         */
        void set(final String renderEngineName, final RenderEngine renderEngine) {
            Validate.notBlank(renderEngineName, "The given name must not be null.");
            ...
            this.renderEngineMapping.put(renderEngineName, renderEngine);
        }
    }
    ...
    public static RenderEngine getDefault() {
        return get(Holder.DEFAULT_RENDER_ENGINE);
    }
    ...
    public static RenderEngine get(final String renderEngineName) {
        return Holder.INSTANCE.get(renderEngineName);
    }
    ...
    public static void set(final String renderEngineName, final RenderEngine renderEngine) {
        Holder.INSTANCE.set(renderEngineName, renderEngine);
    }
